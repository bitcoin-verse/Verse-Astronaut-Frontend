...
contract VerseReel is Ownable {
    ...
    // polygon coordinator 0xAE975071Be8F8eE67addBC1A82488F1C24858067
    constructor(uint _characterCost, address _vrfCoordinatorV2Address) 
    {
        nftContract = new VerseReelNFT(_vrfCoordinatorV2Address, "CHAR", "CHR");
    ...
    function buyCharacter(address receiver) public {
        ...
        nftContract.mint(_ticketReceiver);
    }
